...
#   x.interest = test.df[1, ]
#   x = list(num = x.interest$num + 0.05,
#     char = setdiff(c("a", "b"), x.interest$char)[[1]],
#     fact = factor(setdiff(c("b", "c"), x.interest$fact)[[1]], levels = discval),
#     int = setdiff(1:2, x.interest$int)[[1]],
