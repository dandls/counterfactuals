...
In the following, we explain the integration of new methods through the exemplary integration of the  [`featureTweakR` package](https://github.com/katokohaku/featureTweakR) which implements the feature-tweaking technique of 
Tolomei et al. (2017). 
